...
const { createPostalAddress, createTelecomNumber, createEmailAddress } = useFacilityMutations(props.facilityId);
...
async function addAddress() {
  ...
  try {
    const resp = await createPostalAddress({
