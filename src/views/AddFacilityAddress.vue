...
const { addFacilityAddress, addFacilityPhone, addFacilityEmail } = useFacilityMutations(props.facilityId);
...
async function addAddress() {
  ...
  try {
    const resp = await addFacilityAddress(formData.value);
