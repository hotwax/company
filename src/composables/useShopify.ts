...
export const fetchTypeMappingsForShop = async (shopId: string, mappedTypeId: string): Promise<any[]> => {
  let mappings: any[] = [];
  let pageIndex = 0;
  let resp: any;
  do {
...
export const fetchCarrierShipmentsForShop = async (shopId: string): Promise<any[]> => {
  let shipments: any[] = [];
  let pageIndex = 0;
  let resp: any;
  do {
