...
- `superpowers/` — completed May–June 2026 implementation plans (AccxUI migration + Moqui login, add
  Shopify connection, agent UX wiring, cold-start product-store onboarding).
